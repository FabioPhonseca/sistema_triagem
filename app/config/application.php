...
return [
    'general' =>  [
        ...
        'language' => 'pt',
        'application' => 'SISTEMA TRIAGEM DE COMPARECIMENTO',
        'title' => 'Sistema de triagem',
        'theme' => 'adminbs5',
        'seed' => 'rgfu6asnodf4rs43',
        'rest_key' => '',
        'multiunit' => '0',
        'public_view' => '0',
        'public_entry' => '',
        ...
        'welcome_message' => 'Seja bem vindo ao Sistema XYZ',
    ...
    'login' => [
        ...
        'background' => 'app/images/fundo.png'
    ],
    'template' => [
        'navbar' => [
        ...
        'theme' => [
            'menu_dark_color' => 'rgb(42 104 143)',
            'menu_mode'  => 'dark',
            'main_mode'  => 'light'
        ]
    ]
